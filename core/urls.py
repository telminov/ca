...
urlpatterns = [
    ...
    url(r'^certificates/(?P<pk>[0-9]+)/download_crt/$', certificates.DownloadCrt.as_view(), name='certificate_download'),
    url(r'^certificates/(?P<pk>[0-9]+)/download_key/$', certificates.DownloadKey.as_view(), name='key_download'),
    ...
    url(r'^root_crt/download_crt/$', root_crt.DownloadRootCrt.as_view(), name='download_root_crt'),
